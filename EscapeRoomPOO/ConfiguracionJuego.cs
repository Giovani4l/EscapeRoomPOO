...
namespace EscapeRoomPOO
{
    public static class ConfiguracionJuego
    {
        ...
        public static readonly Color ColorVerde       = Color.FromArgb(46,  204, 113);
        public static readonly Color ColorRojo        = Color.FromArgb(192, 57,  43);
        public static readonly Color ColorVictoria    = Color.FromArgb(39,  174, 96);
        public static readonly Color ColorPanelVerde  = Color.FromArgb(220, 245, 220);
        public static readonly Color ColorPanelRojo   = Color.FromArgb(245, 220, 220);
